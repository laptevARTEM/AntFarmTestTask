        ...
        <div class="content main-content">
            <div class="main-banner">
                <div class="main-banner-text-part">
                    <p class="main-banner-text main-banner-title-book">Адмін</p>
                    <p class="main-banner-text main-banner-title-place">Панель</p>
                </div>
                <div class="elips"></div>
                <div class="logo-block">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="save-header">Зберегти зміни</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($books as $book)
                            <tr>
                                ...
                                <td class="status">
                                    <input class="status-input" type="text" value="{{ $book->status }}">
                                </td>
                                <td class="remove">
                                ...
                                <td>
                                    <button data-id='{{ $book->id }}' class="save-btn">Зберегти</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
